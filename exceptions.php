...
return [
    ...
    'node' => [
        ...
        'daemon_off_config_updated' => '<strong>已更新</strong>守護程序設定，但在嘗試自動更新守護程序設定文件時發生錯誤。您需要手動更新守護程序的設定文件（core.json）以應用更改。',
    ],
    'allocations' => [
    ...
    'nest' => [
        ...
        'egg' => [
            'delete_has_servers' => '無法刪除附著到活躍伺服器上的管理模塊。',
            'invalid_copy_id' => '用於複製腳本的管理模板不存在，或腳本本身不存在。',
            'must_be_child' => '“複製設置自”選項指定的目標必須為所選管理模塊的子選項。',
